...
import { generateGridRowData } from '../utils/helperFunctions'

const GridPanel = ({ heading, tableColumnHeadings, tableData, dataLoading }) => {
    const tableColumns = tableColumnHeadings.map(headingTitle => {
        return <td key={headingTitle}>{headingTitle}</td>
    })
