...
import { generateGridHeadings } from './utils/helperFunctions'
...
const App = () => {
    ...
    // console.log(`Trips Data: ${JSON.stringify(tripsData)}`)
                    ...
                    <div className="fd-flex-row flex-content-row">
                        <div className="fd-content-widget white-bg col-2">
                            ...
                            <p>
                                ...
                                free responsive admin template</a> for everyone. Feel free to use this template for your backend user interfaces. Please tell your friends about
                                <a href="http://www.fd.com" target="_parent">fd.com</a> website. You may <a href="http://www.fd.com/contact" target="_parent">contact us</a> if you have anything to say.</p>
