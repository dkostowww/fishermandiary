      ...
      <div className="fd-content col-1 light-gray-bg">
        ...
        <div className="fd-content-container">
              ...
              <div className="fd-content-widget white-bg fd-overflow-hidden">
                ...
                <div className="fd-flex-row flex-content-row">
                  <div className="col-1 col-lg-6 col-md-12">
                    <h2 className="text-center">Modular<span className="badge">new</span></h2>
                    <div id="pie_chart_div" className="fd-chart"></div>
                    {/* <!-- Pie chart div --> */}
                  </div>
                  <div className="col-1 col-lg-6 col-md-12">
                    <h2 className="text-center">Interactive<span className="badge">new</span></h2>
                    <div id="bar_chart_div" className="fd-chart"></div>
                    {/* <!-- Bar chart div --> */}
                  </div>  
                </div>                
              </div>
          ...
          <footer className="text-right">
            <p>Copyright &copy; 2022 Fisherman Diary 
